    ...
    this.state = {
      sections: [
        ...
        },
        {
          ...
          imageUrl: Project3,
          id: 2,  
          description: "The idea behind this project was to create a simple website to showcase my skills and projects. I build almost everything from scratch with mostly with React and Sass.",
